...
ALTER TABLE places ADD COLUMN IF NOT EXISTS kind TEXT DEFAULT 'other';
ALTER TABLE places ADD COLUMN IF NOT EXISTS address TEXT;
ALTER TABLE places ADD COLUMN IF NOT EXISTS zone_mode TEXT DEFAULT 'place';
